...
function ProductList({onPresSed}) {
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a onClick={handleShowStore} style={{ textDecoration: 'none' }}>
                            <div>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <span className="cart-count">{totalQuantity}</span> {/* Mostrar la cantidad total */}
                            </h1>
                        </a>
                    </div>
                </div>
